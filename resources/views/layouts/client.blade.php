    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3 small">Client Portal </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('client.ads.index') }}">
                    <i class="fab fa-adversal"></i>
                    <span>My Ads</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('client.adreports.index') }}">
